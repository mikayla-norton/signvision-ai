...
def plot_confusion_matrix(cm,
    ...
    Font sizes and figure size are now configurable.
    """
    ...
    plt.xticks(tick_marks, classes, rotation=90, fontsize=tick_fontsize)
...
def distPlot(y_train, labels):
    ...
    # Plot histogram.
    n, bins, patches = ax.hist(y_train, 29, color='green', edgecolor="white")
