...
col1.markdown("<p style='text-align: justify;'>Nice to 'e-meet' you! My name is Mikayla, I am the developer of SignVision AI. I am currently a data scientist with Intel's global supply chain. I am a passion-centric learner, with a drive to always challenge myself for something new. I hope you've enjoyed my application so far.</p>", unsafe_allow_html=True)
col1.write("")
